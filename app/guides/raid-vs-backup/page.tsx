...
export const metadata: Metadata = {
  title: "RAID vs Backup: What You Actually Need | NASforBeginners",
        ...
        <div style={{ maxWidth: "42rem", margin: "0 auto" }}>
          <nav aria-label="Breadcrumb" style={{ marginBottom: "2rem" }}>
            <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.8rem", color: "var(--ink-4)" }}>
              ...
              <span style={{ color: "var(--ink-3)" }}>RAID vs Backup: What You Actually Need</span>
            </p>
          </nav>
          <p style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.65rem", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "var(--accent)", marginBottom: "0.875rem" }}>Storage</p>
          <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(1.75rem, 5vw, 2.75rem)", fontWeight: 800, lineHeight: 1.15, letterSpacing: "-0.025em", color: "var(--ink)", marginBottom: "1rem" }}>
            RAID vs Backup: What You Actually Need
          </h1>
          <div style={{ display: "flex", gap: "1rem", marginBottom: "2.5rem", paddingBottom: "2rem", borderBottom: "1px solid var(--border)" }}>
            <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: "0.78rem", color: "var(--ink-4)" }}>6 min read</span>
          </div>
          ...
          <div style={{ marginTop: "2rem", padding: "1.5rem", background: "var(--bg-warm)", border: "1px solid var(--border)", borderRadius: "8px" }}>
            ...
            <a href="/guides/first-server-checklist" style={{ textDecoration: "none" }}>
              <p style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "1.05rem", color: "var(--ink)", marginBottom: "0.3rem" }}>Your First Server: A Practical Checklist</p>
