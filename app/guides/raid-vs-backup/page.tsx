...
export const metadata: Metadata = {
  title: "RAID vs Backup | NASforBeginners",
    ...
    <div style={{ background: "var(--bg)", minHeight: "100dvh", color: "var(--text-1)", fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <main id="main" style={{ padding: "3rem 1.5rem 6rem" }}>
        <div className="wrap-prose" style={{ maxWidth: "36rem" }}>
          <nav className="bc" style={{ marginBottom: "2rem" }}><a href="/">Home</a> / <a href="/#guides">Guides</a> / <span>RAID vs Backup</span></nav>
          <p style={{ fontSize: ".62rem", fontWeight: 600, textTransform: "uppercase", letterSpacing: ".14em", color: "var(--accent)", marginBottom: ".875rem" }}>Storage</p>
          <h1 style={{ fontWeight: 800, fontSize: "clamp(1.75rem, 5vw, 2.5rem)", lineHeight: 1.15, letterSpacing: "-.025em", color: "var(--text-1)", marginBottom: "1rem" }}>RAID vs Backup</h1>
          ...
          <div style={{ marginTop: "1.5rem", padding: "1.25rem", background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "var(--radius-lg)" }}>
            ...
            <a href="/guides/first-server-checklist" style={{ textDecoration: "none" }}>
              <p style={{ fontWeight: 700, fontSize: ".95rem", color: "var(--text-1)", marginBottom: ".2rem" }}>Your First Server: Step by Step</p>
